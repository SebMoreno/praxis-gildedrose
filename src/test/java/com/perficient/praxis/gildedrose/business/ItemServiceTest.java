...
public class ItemServiceTest {
	...
	@BeforeEach
	public void setUp() {
		when(itemRepository.saveAll(anyList())).thenAnswer(list -> list.getArgument(0));
	}
	...
	public void testQualityDecreasesTwiceFast() {
		var item = ItemFactory.newBaseItem(0, "Oreo", 0, 30, Item.Type.NORMAL);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityNeverNegative() {
		var item = ItemFactory.newBaseItem(5, "tostada", 3, 0, Item.Type.NORMAL);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfAgedTypeQualityIncrease() {
		var item = ItemFactory.newBaseItem(6, "pastel", 3, 10, Item.Type.AGED);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfAgedTypeNeverOverFifty() {
		var item = ItemFactory.newBaseItem(8, "huevo", 3, 50, Item.Type.AGED);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfLegendaryTypeNeverSoldAndDegraded() {
		var item = ItemFactory.newBaseItem(10, "hamburguesa", 0, 80, Item.Type.LEGENDARY);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfTicketsTypeSellinOverEleven() {
		var item = ItemFactory.newBaseItem(12, "shakira", 15, 20, Item.Type.TICKETS);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfTicketsTypeSellinOverFiveAndUnderEleven() {
		/* Case 1 */
		var item = ItemFactory.newBaseItem(12, "shakira", 7, 49, Item.Type.TICKETS);
		when(itemRepository.findAll()).thenReturn(List.of(item));
		...
		verify(itemRepository, times(1)).saveAll(anyList());
		/* Case 2 */
		var item2 = ItemFactory.newBaseItem(21, "homero", 10, 49, Item.Type.TICKETS);
	...
	public void testUpdateQualityOfNormalTypeItemUnderZero() {
		var item = ItemFactory.newBaseItem(0, "Oreo", -1, 1, Item.Type.NORMAL);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testUpdateQualityOfLEGENDARYTypeItemUnderZero() {
		var item = ItemFactory.newBaseItem(0, "Oreo", -1, 80, Item.Type.LEGENDARY);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfTicketsTypeSellinOverFiveAndUnderElevenQualityFifty() {
		var item = ItemFactory.newBaseItem(12, "shakira", 5, 49, Item.Type.TICKETS);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfTicketsTypeSellinUnderSix() {
		var item = ItemFactory.newBaseItem(13, "juanes", 5, 20, Item.Type.TICKETS);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfTicketsTypeSellinEqualZero() {
		var item = ItemFactory.newBaseItem(13, "juanes", 0, 20, Item.Type.TICKETS);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfAgedTypeSellinUnderZero() {
		var item = ItemFactory.newBaseItem(15, "tomate", -1, 20, Item.Type.AGED);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testQualityOfAgedTypeQualityEqualFifty() {
		var item = ItemFactory.newBaseItem(27, "zanahoria", -1, 50, Item.Type.AGED);
		when(itemRepository.findAll()).thenReturn(List.of(item));
	...
	public void testCreateItems() {
		...
		when(itemRepository.saveAll(anyList())).thenReturn(List.of(item));
